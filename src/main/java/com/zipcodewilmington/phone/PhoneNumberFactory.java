...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createRandomPhoneNumber() {
        int randomArea = RandomNumberFactory.createInteger(100, 999);
        int randomCentral = RandomNumberFactory.createInteger(100, 999);
        int randomCode = RandomNumberFactory.createInteger(1000, 9999);

        return createPhoneNumberSafely(randomArea,randomCentral,randomCode);
    }
